...
<style>
    ...
    .everything {
        ...
        background-image: url("Media/tommy.webp");
        ...
        <div class="vert-center">
            <div class="container-fluid">
                <div class="row centered">
                    <p class="info">Reserve a Room</p>
                    <p class="subhead">Select the time and day of the week you would like to reserve to see available classrooms.</p>
                </div>

                <form action="reserve_step_2.php" method="GET">
                    <div class="row centered">
